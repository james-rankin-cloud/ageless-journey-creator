              ...
              <div className="space-y-5">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">+1 (250) 590-5787</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm">wellness@agelessliving.ca</p>
                  </div>
                </div>
            ...
            >
              ...
              <div className="absolute -bottom-5 -left-5 bg-card p-3 rounded-xl shadow-xl hidden md:block border border-border/50">
                <div className="w-40 h-28 rounded-lg overflow-hidden grayscale">
                  <img
                    src="https://images.unsplash.com/photo-1559925393-8be0ec4767c8?w=250&h=170&fit=crop"
                    alt="Scenic view of Victoria BC"
                    className="w-full h-full object-cover"
                    loading="lazy"
                  />
                </div>
        ...
        <div className="container mx-auto section-padding">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold tracking-tighter text-foreground mb-3">
              Treatments available in Victoria
            </h2>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto section-padding">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-stretch">
            ...
            >
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2645.123456789!2d-123.38!3d48.45!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zNDjCsDI3JzAwLjAiTiAxMjPCsDIyJzQ4LjAiVw!5e0!3m2!1sen!2sca!4v1234567890"
                width="100%"
                height="100%"
                style={{ border: 0 }}
                allowFullScreen
                ...
                title="Victoria Clinic Location"
                className="grayscale"
              />
          ...
          >
            <div className="relative z-10 space-y-6">
              ...
              <p className="text-background/60 text-base max-w-xl mx-auto">
                Book your consultation at our Victoria clinic today and discover the path to your
                best self.
              </p>
              <Link
                to="/book?location=victoria"
